...
class UpcomingRidesRecyclerViewAdapter : RecyclerView.Adapter<UpcomingRidesRecyclerViewAdapter.RidesViewHolder> () {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): UpcomingRidesRecyclerViewAdapter.RidesViewHolder {
        val viewHolder = UpcomingRidesRecyclerViewAdapter.RidesViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.rides_info_card_layout, parent, false))
        return viewHolder
    }

    override fun onBindViewHolder(holder: UpcomingRidesRecyclerViewAdapter.RidesViewHolder, position: Int) {
    }
